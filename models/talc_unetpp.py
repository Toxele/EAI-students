"""
Unet++ (EfficientNet-B4) — сегментация талька.

Обучение: kaggle/train_talc_segmentation.ipynb
Веса: models/weights/best_talk.pt
"""
...
DEFAULT_WEIGHTS = Path(__file__).resolve().parent / "weights" / "best_talk.pt"
